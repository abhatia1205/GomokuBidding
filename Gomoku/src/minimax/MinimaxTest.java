...
/**
 * is a tester for the minimax stuff
 *
 * @author ndevr
 * @version May 24, 2020
 * @author Period: 5
 ...
 *
 * @author Sources: awefsad
 */
public class MinimaxTest
{

    /**
     * is the test main method
     * 
     * @param args
     *            the args
     */
    public static void main( String args[] )
    {
        ...
        /*
         * for(int i = 0; i < 14; i++){ for(MmPlayer p : players){ Location a =
         * p.nextMove(); System.out.println(a +" " + p); p.testPiece(a);
         * System.out.println(b); } }
         */
    }
}